...
ROOMS = {
    ...
    'hall': {
        ...
        'exits':
            {'south': 'entrance', 'west': 'library',
             'north': 'treasure_room', 'east': 'time_well'},
        'items': [],
        'puzzle':
    ...
    'library': {
          ...
          'exits': {'east': 'hall', 'north': 'armory', 'west': 'alchemy_lab'},
          'items': ['ancient_book'],
    ...
    'alchemy_lab': {
        'description': 'Комната заставлена колбами и ретортами. '
                       'Некоторые жидкости светятся.',
        'exits': {'east': 'library'},
        'items': ['healing_potion'],
        'puzzle': (
            'Запись алхимика: "Я лечу, но не врач. '
            'Меня пьют, но я не вода". (ответ одно слово)',
            'зелье'
        )
    },
    'time_well': {
        'description': 'В центре комнаты глубокий колодец. '
                       'Из него доносится эхо, будто кто-то шепчет числа.',
        'exits': {'south': 'hall'},
        'items': ['treasure_key'],
        'puzzle': (
            'Над колодцем надпись: "Сколько часов показывают часы дважды в сутки?"'
            ' (ответ в цифрах)',
            '12'
        )
    }
